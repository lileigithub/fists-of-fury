...
# 我开始学做游戏的初衷是我不讨厌编程，但我讨厌现在的java web工作的无趣，当在游戏里实现某个有趣的功能时，让人有成就感，但是在工作中做了某个功能，只会让我感觉没意义。
# 目前没动力，是跟教程时间长了，让我感到没耐心了，想要先做个简单的游戏，但是又没有什么有趣的点子，然后开始怀疑自己是适合做游戏，做游戏能不能当作职业。
# ​我在想怎么开始第二步，穿插第一步，不然我可能这次又要半途而废了。（上次跟了一个unity的教程，没跟下去，也许这种方式不适合我）
